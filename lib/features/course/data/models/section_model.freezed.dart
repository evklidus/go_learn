...
abstract class $SectionModelCopyWith<$Res> {
  ...
  $Res call({String name, String time, List<LessonModel> lessons});
}
...
class _$_SectionModel implements _SectionModel {
  ...
  @override
  String toString() {
    return 'SectionModel(name: $name, time: $time, lessons: $lessons)';
  }
  ...
  Map<String, dynamic> toJson() {
    return _$$_SectionModelToJson(this);
  }
}
...
abstract class _SectionModel implements SectionModel {
  const factory _SectionModel(
      ...
      required final List<LessonModel> lessons}) = _$_SectionModel;
